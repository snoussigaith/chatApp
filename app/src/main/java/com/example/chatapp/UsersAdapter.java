...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.userHolder> {
    ...
    public UsersAdapter(ArrayList<Users> users, Context context, OnUserClickListener onUserClickListener) {
        this.users = users;
    ...
    public void onBindViewHolder(@NonNull userHolder holder, int position) {
        ...
        Glide.with(context).load(users.get(position).getProfilePicture()).error(R.drawable.account_img).into(holder.imageView);
